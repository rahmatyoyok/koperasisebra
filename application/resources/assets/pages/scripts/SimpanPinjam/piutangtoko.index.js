var TableDatatablesResponsive = function () {
    ...
    var initTable = function () {
        ...
        var oTable = table.dataTable({
            processing: true,
            serverSide: true,
            ajax: BaseUrl+'/simpanpinjam/piutangtoko/daftar',
            columns:[
                {data : 'niak', name : 'niak'},
                {data : 'nama', name : 'nama'},
                {data : 'born_place',
                ...
                "targets": 0},
                {data : 'total_piutang', name : 'total_piutang', sClass: 'text-right'}, 
                {data : 'piutang_terbayar', name : 'piutang_terbayar', sClass: 'text-right'}, 
                {data : 'sisa_piutang', name : 'sisa_piutang', sClass: 'text-right'}, 

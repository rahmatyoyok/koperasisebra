                  ...
                  <div class="portlet-body">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('perihal') ? 'has-error' : ''}}">
                                    {!! Form::label('perihal', 'Jenis Pekerjaan', ['class' => 'control-label col-md-2'] ) !!}
                                    <div class="col-md-10">
                          ...
                          <div class="col-md-6">
                            <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('perihal') ? 'has-error' : ''}}">
                                {!! Form::label('perihal', 'Nama Pekerjaan', ['class' => 'control-label col-md-2'] ) !!}
                                <div class="col-md-10">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                              <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('perihal') ? 'has-error' : ''}}">
                                  {!! Form::label('perihal', 'Lokasi Pekerjaan', ['class' => 'control-label col-md-2'] ) !!}
                                  <div class="col-md-10">
                                    <select class="form-control">
                                      <option>GUDANG KANTOR UP BRANTAS</option>
                                      <option>GUDANG SENGGURUH</option>
                                      <option>GUDANG SUTAMI</option>
                                    </select>
                                      <div class="form-control-focus"> </div>
                                      <span class="help-block"></span>
                                  </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('perihal') ? 'has-error' : ''}}">
                                {!! Form::label('perihal', 'Nilai Pekerjaan', ['class' => 'control-label col-md-2'] ) !!}
                                <div class="col-md-10">
                                    {!! Form::text('perihal', null, ['class' => 'form-control', 'id' => 'Nomor', 'autofocus'] ) !!}
                                    <div class="form-control-focus"> </div>
                                    <span class="help-block"></span>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('perihal') ? 'has-error' : ''}}">
                                {!! Form::label('perihal', 'Client', ['class' => 'control-label col-md-2'] ) !!}
                                <div class="col-md-10">
                                  <select class="form-control">
                                    <option>PT PJB Unit Pembangkitan Brantas</option>
                                  </select>
                                    <div class="form-control-focus"> </div>
                                    <span class="help-block"></span>
                                </div>

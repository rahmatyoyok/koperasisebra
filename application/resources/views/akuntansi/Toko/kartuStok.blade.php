                            ...
                            <form action="" class="form-horizontal" method="GET">
                                <div class="form-body">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-4">
                                        <input id="tahun" value="{{ date('Y') }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group form-md-line-input">
                                        <label class="control-label col-md-3">Triwulan</label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-9">
                                            {{ Form::select('item', $item, null, ['class' => 'form-control select2','id'=>'item']) }}
                                        </div>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      $("#ambilData").on("click", function(){
          ...
          $.ajax({
          type: "GET",
          url: "{{ url('akuntansi/toko/kartu-stok') }}?tahun="+tahun+"&triwulan="+triwulan+"&item="+item,
          dataType: "html",

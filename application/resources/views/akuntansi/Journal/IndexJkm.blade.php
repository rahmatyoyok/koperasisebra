...
@push('scripts')
    ...
    <!-- BEGIN PAGE LEVEL PLUGINS -->
    <script src="{{ assets('pages/scripts/SimpanPinjam/simpananpokok.js') }}" type="text/javascript"></script>
    <!-- END PAGE LEVEL PLUGINS -->
@endpush
...
<div class="page-head">
    <div class="container-fluid">
        ...
        <div class="page-title">
            <h1>Jurnal Pemasukan Kas (JKM)</h1>
        </div>
    </div>
</div>
<!-- END PAGE HEAD-->
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="portlet light ">
                              <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <a href="{{ url('akuntansi/jurnal/entryjkm') }}" class="btn sbold green"> <i class="fa fa-plus"></i> Tambah Transaksi JKM </a>
                                    </div>
                              </div>
                              <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="table_simpok">
                                            <thead>
                                                <tr>

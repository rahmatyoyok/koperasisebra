            ...
            <div class="col-lg-12 col-xs-12 col-sm-12">
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">                            
                            {!! Form::model($data_edit, ['method' => 'PATCH', 'url' => ['akuntansi/coa', $data_edit->coa_id], 'class' => 'form-horizontal', 'id'=>'formcoa']) !!}                       
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-6">

                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('first_name') ? 'has-error' : ''}}">
                                            {!! Form::label('group_coa', 'Group COA', ['class' => 'control-label col-md-4 required-input'] ) !!}
                                        <div class="col-md-8">
                                            {!! Form::text('group_coa', $data_edit->group_coa_id, ['class' => 'form-control input-sm uppercase', 'data-required'=>1]) !!}
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('first_name') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-md-8">
                                            {!! Form::text('header_coa', $data_edit->header_coa_id, ['class' => 'form-control input-sm uppercase', 'data-required'=>1]) !!}
                                            <div class="form-control-focus"> </div><span class="help-block"></span>
                                        </div>
                                    </div>
                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('first_name') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-md-8">
                                            {!! Form::text('group_detail', $data_edit->group_detail, ['class' => 'form-control input-sm uppercase', 'data-required'=>1]) !!}
                                            <div class="form-control-focus"> </div><span class="help-block"></span>
                                        </div>
                                    </div>
                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('first_name') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-md-8">
                                            {!! Form::text('activity_code', $data_edit->activity_code, ['class' => 'form-control input-sm uppercase', 'data-required'=>1]) !!}
                                            <div class="form-control-focus"> </div><span class="help-block"></span>
                                        </div>
                                    </div>
                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('first_name') ? 'has-error' : ''}}">
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('first_name') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-md-8">
                                            {!! Form::text('keterangan', $data_edit->desc, ['class' => 'form-control input-sm uppercase', 'data-required'=>1]) !!}
                                            <div class="form-control-focus"> </div><span class="help-block"></span>
                                        </div>
                                    </div>

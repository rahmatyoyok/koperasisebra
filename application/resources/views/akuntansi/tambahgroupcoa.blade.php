                      ...
                      <div class="row">
                        ...
                        <!-- BEGIN VALIDATION STATES-->
                          <div class="portlet light portlet-fit portlet-form ">
                              ...
                              <div class="portlet-body">
                                <!-- BEGIN FORM-->
                                {!! Form::open(['route' => 'groupcoa.store', 'class' => 'form-horizontal', 'method' => 'POST', 'id'=>'frmCoa']) !!}
                                    <div class="form-body">                                        
                                            @if (session('status'))
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('group_coa') ? 'has-error' : ''}}">
                                                    {!! Form::label('group_coa_type', 'Group COA Type', ['class' => 'control-label col-md-4 required-input','required'] ) !!}
                                                    <div class="col-md-8">
                                                        {!! Form::text('group_coa_type','', ['class' => 'form-control input-sm uppercase', 'data-required'=>1]) !!}
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('header_coa') ? 'has-error' : ''}}">
                                                        {!! Form::label('code', 'Kode', ['class' => 'control-label col-md-4 required-input'] ) !!}
                                                    <div class="col-md-8">
                                                        {!! Form::text('kode','', ['class' => 'form-control input-sm uppercase', 'data-required'=>1]) !!}
                                                        <div class="form-control-focus"> </div><span class="help-block"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('group_detail') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        {!! Form::text('desc','', ['class' => 'form-control input-sm uppercase', 'data-required'=>1]) !!}
                                                        <div class="form-control-focus"> </div><span class="help-block"></span>
                                                    </div>
                                                </div>

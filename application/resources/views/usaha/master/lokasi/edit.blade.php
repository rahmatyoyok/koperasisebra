            ...
            <div class="mt-content-body">
				<div class="row">
                    ...
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject bold uppercase">Ubah Lokasi</span>
                        </div>
                    </div>
                        ...
                        {!! Form::model($data_edit, [
                            'method' => 'PATCH',
                            'url' => ['usaha/master/lokasi', $data_edit->lokasi_id],
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    {!! Form::button('<i class="fa fa-check"></i> Simpan', ['class' => 'btn blue-sharp col-md-3 simpan', 'type' => 'submit', 'data-swa-text' => 'Merubah Lokasi']) !!}

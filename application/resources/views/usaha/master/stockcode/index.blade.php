...
@section('title', 'Master Stockcode')
            ...
            <div class="mt-content-body">
				<div class="row">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a class="btn green-jungle col-md-12" href="{{ url('usaha/master/stockcode/create') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="table1" cellspacing="0">
                                            ...
                                            <tfoot>
                                                <tr>
                                                  <th class="form-group form-md-line-input">Stockcode</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#table1").DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! url('usaha/master/stockcode') !!}',
            columns: [
                {data: 'stockcode', name: 'stockcode'},
                {data: 'nama_stockcode', name: 'nama_stockcode'},

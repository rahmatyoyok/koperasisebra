            ...
            <div class="mt-content-body">
				<div class="row">
                    ...
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject bold uppercase">Tambah Pr</span>
                        </div>
                    </div>
				            <div class="portlet-body form">

                        {!! Form::open(['route' => 'pr.store', 'class' => 'form-horizontal']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('status') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-md-10">
                                            {{ Form::select('status', getPR(), null, ['class' => 'form-control ']) }}
                                            <div class="form-control-focus"> </div>
                        ...
                        <div class="form-actions">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    {!! Form::button('<i class="fa fa-check"></i> Simpan', ['class' => 'btn blue-sharp col-md-3 simpan', 'type' => 'submit', 'data-swa-text' => 'Menambahkan PR']) !!}

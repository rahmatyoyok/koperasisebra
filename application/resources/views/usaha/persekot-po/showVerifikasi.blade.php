...
<div class="page-head">
    <div class="container">
        ...
        <div class="page-title">
            <h1>Verifikasi Persekot PO -  {{ $data_edit->no_persekot }}
            </h1>
        </div>
    </div>
</div>
            ...
            <div class="mt-content-body">
				<div class="row">
				    <div class="col-lg-12 col-xs-12 col-sm-12">
                      ...
                      {!! Form::open(['url' => url('usaha/persekotpo/verifikasi-persekot'),'method'=>'POST', 'class' => 'form-horizontal']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <p class="form-control-static"> Verifikasi </p>
                                    </div>
                                </div>
                            </div>
                            <!--/span-->
                      ...
                      <div class="form-actions">
                          ...
                          <div class="row">
                              <div class="col-md-12">
                                  ...
                                  {!! Form::button('Simpan', ['class' => 'btn blue-sharp col-md-3 simpan', 'type' => 'submit', 'data-swa-text' => 'Verifikasi Persekot']) !!}

...
@section('title', 'Ubah Persekot PO')
...
<div class="page-head">
    <div class="container">
        ...
        <div class="page-title">
            <h1>Ubah Persekot PO {{ $data_edit->no_persekot }}
            </h1>
        </div>
    </div>
</div>
        				...
        				<div class="row">
        				    <div class="col-lg-12 col-xs-12 col-sm-12">
                              ...
                              {!! Form::model($data_edit, [
                                  'method' => 'PATCH',
                                  'url' => ['usaha/persekotpo', $data_edit->persekot_id],
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                {!! Form::button('<i class="fa fa-check"></i> Simpan', ['class' => 'btn blue-sharp col-md-3 simpan', 'type' => 'submit', 'data-swa-text' => 'Ubah Persekot PO']) !!}

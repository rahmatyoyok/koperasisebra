...
@section('title', 'Ubah Pembelian Langsung')
...
<div class="page-head">
    <div class="container">
        ...
        <div class="page-title">
            <h1>Ubah Pembelian Langsung {{ $data_edit->kode }}
            </h1>
        </div>
    </div>
</div>
              ...
              <div class="portlet light bordered">
                  <div class="portlet-body">
                    ...
                    {!! Form::model($data_edit, [
                        'method' => 'PATCH',
                        'url' => ['usaha/purchase', $data_edit->purchase_id],
                              ...
                              <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('tanggal_pembelian') ? 'has-error' : ''}}">
                                  ...
                                  <div class="col-md-8">
                                      <div class="input-group input-medium">
                                          <input type="text" class="form-control datepicker"  name="tanggal_pembelian" autocomplete="off" value="{{ $tanggal_pembelian }}" >
                    ...
                    <div class="form-actions">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                {!! Form::button('<i class="fa fa-check"></i> Simpan', ['class' => 'btn blue-sharp col-md-3 simpan', 'type' => 'submit', 'data-swa-text' => 'Merubah Pembelian Langsung']) !!}

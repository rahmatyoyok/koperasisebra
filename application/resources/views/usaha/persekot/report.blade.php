...
@section('title', 'Laporan Persekot')
                              ...
                              <div class="col-md-4">
                                  <div class="form-group">
                                      ...
                                      <select class="form-control" id="status">
                                        ...
                                        <option value="4">PNPO</option>
                                        <option value="5">Pembayaran PJB</option>
...
<script type="text/javascript">
    $(document).ready(function(){
      ...
      $("#preview").on("click", function(){
          ...
          $.ajax({
          type: "GET",
          url: "{{ url('usaha/persekot/report') }}?status="+status+"&start="+startDataDate+"&end="+endDataDate,
          dataType: "html",

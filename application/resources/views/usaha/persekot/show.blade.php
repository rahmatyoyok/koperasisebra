...
<div class="page-head">
    <div class="container">
        ...
        <div class="page-title">
            <h1>Data Persekot - {{ $data_edit->no_persekot }}
            </h1>
        </div>
    </div>
</div>
				...
				<div class="row">
				    <div class="col-lg-12 col-xs-12 col-sm-12">
                        ...
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject bold uppercase">Informasi Persekot</span>
                            </div>
                            <div class="actions">
                                @if($data_edit->status == 3)
                                <a class="btn blue" href="{{ url('usaha/persekot/pindah-persekotpo/'.$data_edit->persekot_id) }}">
                                        Pindah Persekot PO
                                </a>
                                @endif
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li>
                                        <a target="_blank" href="{{ url('usaha/pdf/persekot?kd='.$data_edit->persekot_id.'&status=1') }}">
                                            Permintaan
                                        </a>
                                        </li>
                                        <li>
                                        <a target="_blank" href="{{ url('usaha/pdf/persekot?kd='.$data_edit->persekot_id.'&status=2') }}">
                                            Verifikasi
                                        </a>
                                        </li>
                                        <li>
                                        <a target="_blank" href="{{ url('usaha/pdf/persekot?kd='.$data_edit->persekot_id.'&status=3') }}">
                                            Realisasi
                                        </a>
                                        </li>
                                        <li>
                                        <a target="_blank" href="{{ url('usaha/pdf/persekot?kd='.$data_edit->persekot_id.'&status=4') }}">
                                            PNPO
                                        </a>
                                        </li>
                                    </ul>

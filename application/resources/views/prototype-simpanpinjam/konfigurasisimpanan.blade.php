                                          ...
                                          <div class="form-group form-md-line-input">
                                              ...
                                              <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="f_default_simpanan_pokok" class="form-control text-right" placeholder="200.000"> 
                                                </div> 
                                              </div>
                                          </div>
                                          ...
                                          <div class="form-group form-md-line-input">
                                              ...
                                              <div class="col-md-2">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="f_default_simpanan_pokok" class="form-control text-right" placeholder="5"> 
                                                </div> 
                                              </div>
                                          </div>

                      ...
                      <div class="row">
                        ...
                        <!-- BEGIN VALIDATION STATES-->
                          <div class="portlet light portlet-fit portlet-form ">
                              ...
                              <div class="portlet-body">
                                <!-- BEGIN FORM-->
                                {!! Form::open(['route' => 'anggota.store', 'class' => 'form-horizontal', 'method' => 'POST', 'id'=>'formSpPokok']) !!}
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('first_name') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        {!! Form::text('first_name', '', ['class' => 'form-control input-sm uppercase', 'data-required'=>1]) !!}
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('last_name') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        {!! Form::text('last_name', '', ['class' => 'form-control input-sm uppercase']) !!}
                                                        <div class="form-control-focus"> </div><span class="help-block"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('born_place') ? 'has-error' : ''}}  {{ $errors->has('born_date') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="input-group">
                                                            ...
                                                            {!! Form::text('born_place', '', ['class' => 'form-control input-sm uppercase',]) !!}
                                                            <div class="form-control-focus"> </div><span class="help-block"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
                                                            ...
                                                            {!! Form::text('born_date', '', ['class' => 'form-control input-sm ']) !!}
                                                ...
                                                <div class="form-group form-md-radios">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="md-radio-list">
                                                            <div class="md-radio">
                                                                <input type="radio" id="checkbox1_6" name="f_jeniskelamin" value="1" class="md-radiobtn" checked="checked" >
                                                            ...
                                                            <div class="md-radio">
                                                                <input type="radio" id="checkbox1_7" name="f_jeniskelamin" value="0" class="md-radiobtn">
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('id_card_number') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        {!! Form::text('id_card_number', '', ['class' => 'form-control input-sm ']) !!}
                                                        <div class="form-control-focus"> </div><span class="help-block"></span>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="form-group form-md-line-input {{ $errors->has('address_1') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        {!! Form::textarea('address_1', "-", ['class' => 'form-control input-sm ', 'rows' => 4, 'cols' => 54]) !!}
                                                        <div class="form-control-focus"> </div><span class="help-block"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('city') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group">
                                                            ...
                                                            {!! Form::text('city', 'Malang', ['class' => 'form-control input-sm ']) !!}
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('state') ? 'has-error' : ''}}">
                                                        {!! Form::label('state', 'Provinsi', ['class' => 'control-label col-md-4 '] ) !!}
                                                    <div class="col-md-8">
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                                                <i class="fa fa-map"></i>
                                                            </span>
                                                            {!! Form::text('state', 'Jawa Timur', ['class' => 'form-control input-sm ']) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('country') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group">
                                                            ...
                                                            {!! Form::text('country', 'Indonesia', ['class' => 'form-control input-sm ']) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('npwp') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group">
                                                            ...
                                                            {!! Form::text('npwp', '-', ['class' => 'form-control input-sm ', 'data-required'=>1]) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('email') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group">
                                                            ...
                                                            {!! Form::text('email', '-', ['class' => 'form-control input-sm ', 'data-required'=>1]) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('phone_number') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group">
                                                            ...
                                                            {!! Form::text('phone_number', '+62', ['class' => 'form-control input-sm ', 'data-required'=>1]) !!}
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('member_type') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        {{ Form::select('member_type', $list_member_type, 1, ['class' => 'form-control select2']) }}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('member_status') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        {{ Form::select('member_status', $list_member_status, 1, ['class' => 'form-control select2']) }}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('member_status') ? 'has-error' : ''}}  {{ $errors->has('account_number') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="input-group">
                                                            ...
                                                            {!! Form::text('account_number', '', ['class' => 'form-control input-sm ', 'data-required'=>1]) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label{ $errors->has('company_name') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group">
                                                            ...
                                                            {!! Form::text('company_name', 'PJB Unit Brantas', ['class' => 'form-control input-sm ']) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label{ $errors->has('nomor_induk') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group">
                                                            ...
                                                            {!! Form::text('nomor_induk', '-', ['class' => 'form-control input-sm ']) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label{ $errors->has('jabatan') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="input-group">
                                                            ...
                                                            {!! Form::text('jabatan', '-', ['class' => 'form-control input-sm ']) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label{ $errors->has('credit_limit') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="input-group">
                                                            ...
                                                            {!! Form::text('credit_limit', 150000000, ['class' => 'form-control input-sm rupiah', 'data-required'=>1]) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-12">
                                                    ...
                                                    {!! Form::button('<i class="fa fa-check"></i> Simpan', ['class' => 'btn blue-sharp col-md-3 simpan', 'type' => 'submit', 'data-swa-text' => 'Menambahkan Angggota', 'style' => 'margin-right:5px;']) !!}

...
<div class="page-head">
    <div class="container-fluid">
        ...
        <div class="page-title">
            <h1>Pengajuan Pengunduran Diri Anggota</h1>
        </div>
    </div>
</div>
<!-- END PAGE HEAD-->
                      ...
                      <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="table_resign_anggota">
                                        <thead>
                                            <tr>
                                        ...
                                        <tfoot>
                                            <tr>
                                              ...
                                              <th class="form-group form-md-line-input">No. Telp</th>
                                              <th class="form-group form-md-line-input">Alamat</th>
                                              <th class="form-group form-md-line-input">Jenis Anggota</th>
                                              <th class="form-group form-md-line-input">Jenis Anggota</th>
                                              <th class="text-center" width="150">Aksi</th>
                                            </tr>
                                        </tfoot>

                        ...
                        <div class="col-lg-12 col-xs-12 col-sm-12">
                            <div class="portlet light bordered">
                                <div class="portlet-body form">
                                    {!! Form::open(['url' => url('simpanpinjam/pinjaman/apprterima/'.$idEncrypt),'method'=>'POST', 'class' => 'form-horizontal','enctype' => 'multipart/form-data']) !!}
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-6">
                                                    <div class="form-group form-md-line-input form-md-floating-label  {{ $errors->has('person_id') ? 'has-error' : ''}}">
                                                        {!! Form::label('limit_pinjaman', 'Limit Pinjaman', ['class' => 'control-label col-md-4'] ) !!}
                                                        <div class="col-md-8">
                                                            <p class="form-control-static"> : Rp. {{ formatNoRpComma($data->anggota->customer->credit_limit) }} </p>
                                                        </div>
                                                    </div>

                                                    <div class="form-group form-md-line-input form-md-floating-label  {{ $errors->has('person_id') ? 'has-error' : ''}}">
                                                        {!! Form::label('saldo_pokok_pinjaman', 'Saldo Pinjaman', ['class' => 'control-label col-md-4'] ) !!}
                                                        <div class="col-md-8">
                                                            <p class="form-control-static"> : Rp. {{ formatNoRpComma($data->saldo_pinjaman) }} </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('loan_amount') ? 'has-error' : ''}}">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="input-group">
                                                                ...
                                                                {!! Form::text('loan_amount', formatNoZeroRpComma($data->loan_total), ['class' => 'form-control rupiah'] ) !!}
                                                                <div class="form-control-focus"> </div>
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('loan_type_id') ? 'has-error' : ''}}">
                                                        ...
                                                        <div class="col-md-8">
                                                            <p class="form-control-static"> {{ $listLoanTypes[$SelectedLoanTypes] }} </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('biaya_administrasi_rupiah') ? 'has-error' : ''}}">
                                                        {!! Form::label('biaya_administrasi_rupiah', 'Biaya Administrasi', ['class' => 'control-label col-md-4 required-input '] ) !!}
                                                        <div class="col-md-5">
                                                            <div class="input-group">
                                                                <span class="input-group-addon">
                                                                    <i class="fa fa-money"></i>
                                                                </span>
                                                                {!! Form::text('biaya_administrasi_rupiah', formatNoZeroRpComma($data->biaya_administrasi_rupiah), ['class' => 'form-control rupiah'] ) !!}
                                                                <div class="form-control-focus"> </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('biaya_provisi_rupiah') ? 'has-error' : ''}}">
                                                        {!! Form::label('biaya_provisi_rupiah', 'Biaya Provisi', ['class' => 'control-label col-md-4 required-input '] ) !!}
                                                        <div class="col-md-5">
                                                            <div class="input-group">
                                                                <span class="input-group-addon">
                                                                    <i class="fa fa-money"></i>
                                                                </span>
                                                                {!! Form::text('biaya_provisi_rupiah', formatNoZeroRpComma($data->biaya_provisi_rupiah), ['class' => 'form-control rupiah'] ) !!}
                                                                <div class="form-control-focus"> </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('resiko_daperma') ? 'has-error' : ''}}">
                                                        {!! Form::label('resiko_daperma', 'Biaya Resiko Daperma', ['class' => 'control-label col-md-4 required-input '] ) !!}
                                                        <div class="col-md-5">
                                                            <p class="form-control-static"> : Rp. {{ formatNoRpComma($data->resiko_daperma) }} </p>
                                                        </div>
                                                    </div>
                    
                                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('biaya_materai') ? 'has-error' : ''}}">
                                                        {!! Form::label('biaya_materai', 'Biaya Materai', ['class' => 'control-label col-md-4 required-input '] ) !!}
                                                        <div class="col-md-5">
                                                            <p class="form-control-static"> : Rp. {{ formatNoRpComma($data->biaya_materai) }} </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('biaya_lain') ? 'has-error' : ''}}">
                                                        ...
                                                        <div class="col-md-5">
                                                            <p class="form-control-static"> : Rp. {{ formatNoRpComma($data->biaya_lain) }} </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label ">
                                                        ...
                                                        <div class="col-md-5">
                                                            <p class="form-control-static"> : <span class="rupiah" id="lJumlahBiaya">{{ formatNoZeroRpComma($data->biaya_administrasi_rupiah + $data->biaya_provisi_rupiah + $data->resiko_daperma + $data->biaya_materai + $data->biaya_lain)  }}</span> </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('totalDiterima') ? 'has-error' : ''}}">
                                                        ...
                                                        <div class="col-md-5">
                                                            <p class="form-control-static"> : <span class="rupiah" id="ltotalDiterima">{{ formatNoRpComma($data->loan_total - ($data->biaya_administrasi_rupiah + $data->biaya_provisi_rupiah + $data->resiko_daperma + $data->biaya_materai + $data->biaya_lain))  }}</span> </p>
                                                            {!! Form::hidden('totalDiterima', formatNoZeroRpComma($data->loan_total - ($data->biaya_administrasi_rupiah + $data->biaya_provisi_rupiah + $data->resiko_daperma + $data->biaya_materai + $data->biaya_lain)) , ['class' => 'form-control'] ) !!}
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('principal_loan_total') ? 'has-error' : ''}}">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <div class="input-group">
                                                                        ...
                                                                        {!! Form::text('principal_loan_total_label', $data->loan_amount, ['class' => 'form-control rupiah','disabled' => 'disabled'] ) !!}
                                                                        {!! Form::hidden('principal_loan_total', formatNoZeroRpComma($data->loan_amount), ['class' => 'form-control'] ) !!}
                                                                    </div>
                                                                </div>
                                                            </div>    
                                                        </div>    
                                                        <div class="col-md-12">
                                                            <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('rates_loan_total') ? 'has-error' : ''}}">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                                                        {!! Form::text('rates_loan_total_label', $data->rates_total, ['class' => 'form-control rupiah','disabled' => 'disabled'] ) !!}
                                                                        {!! Form::hidden('rates_loan_total', formatNoZeroRpComma($data->rates_total), ['class' => 'form-control'] ) !!}
                                                                    </div>
                                                                </div>
                                                            </div>    
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('rates_loan_total') ? 'has-error' : ''}}">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                                                        {!! Form::text('total_hutang_label', formatNoZeroRpComma($data->loan_amount+$data->rates_total), ['class' => 'form-control rupiah','disabled' => 'disabled'] ) !!}
                                                                    </div>
                                                                </div>
                                                            </div>  
                                                        </div>
                                                            ...
                                                            <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('principal_amount') ? 'has-error' : ''}}">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <div class="input-group">
                                                                        ...
                                                                        {!! Form::hidden('principal_amount', formatNoZeroRpComma($data->principal_amount), ['class' => 'form-control'] ) !!}
                                                                    </div>
                                                                </div>
                                                            </div>    
                                                        </div>    
                                                            ...
                                                            <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('rates_amount') ? 'has-error' : ''}}">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <div class="input-group">
                                                                        ...
                                                                        {!! Form::hidden('rates_amount', formatNoZeroRpComma($data->rates_amount), ['class' => 'form-control'] ) !!}
                                                                    </div>
                                                                </div>
                                                            </div>    
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('rates_loan_total') ? 'has-error' : ''}}">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <div class="input-group">
                                                                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                                                        {!! Form::text('total_angsuran_label', formatNoZeroRpComma($data->rates_amount + $data->principal_amount), ['class' => 'form-control rupiah'] ) !!}
                                                                    </div>
                                                                </div>
                                                            </div>  
                                                        </div>

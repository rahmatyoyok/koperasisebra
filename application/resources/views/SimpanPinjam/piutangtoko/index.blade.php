...
@push('scripts')
    ...
    <!-- BEGIN PAGE LEVEL PLUGINS -->
    <script src="{{ assets('pages/scripts/SimpanPinjam/piutangtoko.index.js') }}" type="text/javascript"></script>
    <!-- END PAGE LEVEL PLUGINS -->
@endpush
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <div class="portlet light ">
                              ...
                              <div class="portlet-body">
                                    <table class="table table-striped table-bordered table-hover dt-responsive dtr-inline" width="100%" id="table_pinjaman">
                                          <thead>
                                              <tr>
                                                  ...
                                                  <th class=""> Piutang Terbayar </th>
                                                  <th class=""> Sisa Piutang </th>
                                                  <th class=""> Aksi </th>
                                              </tr>
                                          </thead>
                                          <tbody></tbody>

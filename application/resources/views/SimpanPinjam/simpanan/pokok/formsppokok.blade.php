...
@push('scripts')
    ...
    <script src="{{ assets('pages/scripts/SimpanPinjam/tambahsimpananpokok.js') }}" type="text/javascript"></script>
                      ...
                      <div class="row">
                        ...
                        <!-- BEGIN VALIDATION STATES-->
                          <div class="portlet light portlet-fit portlet-form ">
                              ...
                              <div class="portlet-body">
                                  <!-- BEGIN FORM-->
                                  {!! Form::open(['route' => 'simpananpokok.store', 'class' => 'form-horizontal', 'method' => 'POST', 'id'=>'formSpPokok']) !!}
                                      <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                    {!! Form::label('tr_date', 'Tanggal', ['class' => 'control-label col-md-3 required-input '] ) !!}
                                                <div class="col-md-2">
                                            ...
                                            <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('total') ? 'has-error' : ''}}">
                                                {!! Form::label('total', 'Nilai Simpanan', ['class' => 'control-label col-md-3 required-input '] ) !!}
                                                <div class="col-md-2">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-money"></i>
                                                        </span>
                                                        {!! Form::text('total', $def_total, ['class' => 'form-control rupiah'] ) !!}
                                                        <div class="form-control-focus"> </div>
                                                        <span class="help-block"></span>
                                                    </div>
                                                </div>
                                            ...
                                            {{-- <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('total') ? 'has-error' : ''}}">
                                                {!! Form::label('payment_ref', 'No. Reff pembayaran', ['class' => 'control-label col-md-3 '] ) !!}
                                                <div class="col-md-2">
                                                        {!! Form::text('payment_ref', '', ['class' => 'form-control'] ) !!}
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block"></span>
                                                </div>
                                            </div>                                --}}
                                      ...
                                      <div class="form-actions">
                                          <div class="row">
                                                ...
                                                {!! Form::button('<i class="fa fa-check"></i> Simpan', ['class' => 'btn blue-sharp col-md-3 simpan', 'type' => 'submit', 'data-swa-text' => 'Menambahkan Simpanan Pokok', 'style' => 'margin-right:5px;']) !!}

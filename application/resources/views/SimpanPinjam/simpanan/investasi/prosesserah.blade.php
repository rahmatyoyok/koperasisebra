                        ...
                        <div class="col-lg-12 col-xs-12 col-sm-12">
                            <div class="portlet light bordered">
                                <div class="portlet-body form">
                                    {!! Form::open(['url' => url('simpanpinjam/investasi/apprserah/'.$idEncrypt),'method'=>'POST', 'class' => 'form-horizontal','enctype' => 'multipart/form-data']) !!}
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                    ...
                                                    <div class="col-md-8">
                                                        <p class="form-control-static"> : {{ sp_payment_method_list()[$data->payment_method] }} </p>
                                                    </div>
                                                </div>

                                                <div class="form-group form-md-line-input form-md-floating-label">
                                                        {!! Form::label('tr_date', 'Tanggal Penyerahan', ['class' => 'control-label col-md-4 required-input '] ) !!}
                                                    <div class="col-md-5">
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('member_status') ? 'has-error' : ''}}  {{ $errors->has('account_number') ? 'has-error' : ''}}">
                                                    {!! Form::label('bank_id', 'Rekening Anggota', ['class' => 'control-label col-md-4 required-input'] ) !!}
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('member_status') ? 'has-error' : ''}}  {{ $errors->has('account_number') ? 'has-error' : ''}}">
                                                    {!! Form::label('bank_id', 'No Rekening Anggota', ['class' => 'control-label col-md-4 required-input'] ) !!}
                                                    <div class="col-md-8">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                {!! Form::button('Simpan', ['class' => 'btn blue-sharp col-md-3 simpan', 'type' => 'submit', 'data-swa-text' => 'Penyerahan Investasi', 'style' => 'margin-right:5px;']) !!}

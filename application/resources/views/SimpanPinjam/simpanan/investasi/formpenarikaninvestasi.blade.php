...
@push('scripts')
    ...
    <script src="{{ assets('pages/scripts/SimpanPinjam/penarikanspinvestasi.js') }}" type="text/javascript"></script>
...
<div class="page-head">
    <div class="container-fluid">
        ...
        <div class="page-title">
            <h1>Pengajuan Penarikan Investasi</h1>
        </div>
    </div>
</div>
<!-- END PAGE HEAD-->
                      ...
                      <div class="row">
                        ...
                        <!-- BEGIN VALIDATION STATES-->
                          <div class="portlet light portlet-fit portlet-form ">
                              ...
                              <div class="portlet-body">
                                  <!-- BEGIN FORM-->
                                  {!! Form::open(['url' => 'simpanpinjam/investasi/penarikanstore', 'class' => 'form-horizontal', 'method' => 'POST', 'id'=>'formSpPokok']) !!}
                                      <div class="form-body">
                                          ...
                                          <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('tr_date') ? 'has-error' : ''}}">                                                
                                              {!! Form::label('tr_date', 'Tanggal Pengajuan', ['class' => 'control-label col-md-3 required-input '] ) !!}
                                              <div class="col-md-2">
                                          ...
                                          <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('person_id') ? 'has-error' : ''}}">                                                
                                              {!! Form::label('person_id', 'NIAK', ['class' => 'control-label col-md-3 required-input '] ) !!}
                                                <div class="col-md-4">
                                          ...
                                          <div class="form-group form-md-line-input form-md-floating-label ">
                                                {!! Form::label('total_saldo', 'Saldo Investasi', ['class' => 'control-label col-md-3 required-input '] ) !!}
                                                  <div class="col-md-2">
                                                      <div class="input-group">
                                                          <span class="input-group-addon">
                                                              <i class="fa fa-money"></i>
                                                          </span>
                                                          {!! Form::text('saldo', '', ['class' => 'form-control rupiah',  'disabled' => 'disabled'] ) !!}
                                                      </div>
                                                  </div>
                                            </div>

                                          <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('total') ? 'has-error' : ''}}">
                                              {!! Form::label('total', 'Nilai Penarikan Investasi', ['class' => 'control-label col-md-3 required-input '] ) !!}
                                                <div class="col-md-2">
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-money"></i>
                                          ...
                                          <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-2">
                                                    {{ Form::select('payment_method', sp_payment_method_list(), null, ['class' => 'form-control select2']) }}
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block"></span>
                                                </div>
                                          </div>
                                      ...
                                      <div class="form-actions">
                                            <div class="row">
                                                    ...
                                                    {!! Form::button('<i class="fa fa-check"></i> Simpan', ['class' => 'btn blue-sharp col-md-3 simpan', 'type' => 'submit', 'data-swa-text' => 'Menambahkan Pengajuan Penarikan Investasi', 'style' => 'margin-right:5px;']) !!}

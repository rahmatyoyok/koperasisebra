...
@push('scripts')
    ...
    <script src="{{ assets('pages/scripts/SimpanPinjam/simpananwajib.show.js') }}" type="text/javascript"></script>
            ...
            <div class="col-lg-12 col-xs-12 col-sm-12">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject bold uppercase">Informasi Simpanan Wajib Anggota</span>
                        </div>
                        <div class="actions">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> 
                                                                ...
                                                                if($value->is_deleted <> 1){
                                                                    ...
                                                                    echo '<div class="btn btn-xs btn-circle red font-weight-normal" style="cursor: auto!important;"> batal </div>';
                                                                }
                                                                @endphp
                                                            </td>
                                                            <td class="text-center"> 
                                                                @if((int)$value->status <> 2 && (int)$value->is_deleted <> 1)
                                                                    {!! Form::button('<i class="fa fa-money"></i> Proses Penerimaan', ['class' => 'btn btn-xs blue moveLink', 'data-swa-text' => 'Memproses Penerimaan Simpanan Wajib', 'data-spwjbid'=>Crypt::encrypt($value->periodic_saving_id)]) !!}
                                                                    {!! Form::button('<i class="fa fa-remove"></i> Batal', ['class' => 'btn btn-xs red moveLinkBatal', 'data-swa-text' => 'Pembatalan Simpanan Wajib', 'data-spwjbid'=>Crypt::encrypt($value->periodic_saving_id)]) !!}
                                                                @endif
                                                            </td>
                                                        </tr>
                                                        @php $i++; @endphp

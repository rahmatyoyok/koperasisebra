    ...
    <div class="page-head">
        <div class="container">
            ...
            <div class="page-title">
                <h1> Penerimaan Simpanan Wajib - Ref. Code : {{ $data->ref_code }}</h1>
            </div>
        </div>
    </div>
    <!-- END PAGE HEAD-->
                        ...
                        <div class="col-lg-12 col-xs-12 col-sm-12">
                            <div class="portlet light bordered">
                                <div class="portlet-body form">
                                    {!! Form::open(['url' => url('simpanpinjam/wajib/apprterima/'.$idEncrypt),'method'=>'POST', 'class' => 'form-horizontal','enctype' => 'multipart/form-data']) !!}
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                {!! Form::button('Simpan', ['class' => 'btn blue-sharp col-md-3 simpan', 'type' => 'submit', 'data-swa-text' => 'Menerima Pembayaran Simpanan Wajib', 'style' => 'margin-right:5px;']) !!}

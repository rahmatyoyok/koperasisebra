...
<div class="page-head">
    <div class="container-fluid">
        ...
        <div class="page-title">
            <h1>Pengajuan (Setor) Simpanan Wajib</h1>
        </div>
    </div>
</div>
<!-- END PAGE HEAD-->
                      ...
                      <div class="row">
                        ...
                        <!-- BEGIN VALIDATION STATES-->
                          <div class="portlet light portlet-fit portlet-form ">
                              ...
                              <div class="portlet-body">
                                  <!-- BEGIN FORM-->
                                  {!! Form::open(['route' => 'wajib.store', 'class' => 'form-horizontal', 'method' => 'POST', 'id'=>'formSpWajib']) !!}
                                      <div class="form-body">
                                            ...
                                            {{-- <div class="form-group form-md-line-input">
                                              {!! Form::label('payment_method', 'Cara Penerimaan', ['class' => 'control-label col-md-3 required-input'] ) !!}
                                                <div class="col-md-2">
                                                    {{ Form::select('payment_method', array("1"=>"CASH",2=>"BANK"), 2, ['class' => 'form-control select2']) }}
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block"></span>
                                                </div>
                                            </div>            --}}
                                      ...
                                      <div class="form-actions">
                                          <div class="row">
                                                ...
                                                {!! Form::button('<i class="fa fa-check"></i> Simpan', ['class' => 'btn blue-sharp col-md-3 simpan', 'type' => 'submit', 'data-swa-text' => 'Menambahkan Simpanan Wajib', 'style' => 'margin-right:5px;']) !!}

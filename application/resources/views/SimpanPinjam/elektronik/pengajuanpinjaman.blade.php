...
@push('scripts')
    ...
    <script src="{{ assets('pages/scripts/SimpanPinjam/loan-elektronik.form.create.js') }}" type="text/javascript"></script>
          ...
          <div class="col-lg-12 col-xs-12 col-sm-12">
              <div class="portlet light bordered">
                  <div class="portlet-body">
                    ...
                    {!! Form::open(['route' => 'elektronik.store', 'class' => 'form-horizontal', 'method' => 'POST', 'id'=>'formSpPokok']) !!}
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-md-line-input form-md-floating-label">&nbsp;</div>

                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('unit_desc') ? 'has-error' : ''}}">
                                    {!! Form::label('unit_desc', 'Nama Barang', ['class' => 'control-label col-md-4 required-input bold'] ) !!}
                                    <div class="col-md-8">
                                        
                                            {!! Form::text('unit_desc', "", ['class' => 'form-control'] ) !!}
                                            <div class="form-control-focus"> </div>
                                            <span class="help-block"></span>
                                ...
                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('loan_amount') ? 'has-error' : ''}}">
                                    {!! Form::label('loan_amount', 'Nilai Barang', ['class' => 'control-label col-md-4 required-input bold'] ) !!}
                                    <div class="col-md-5">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                ...
                                <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('tenure') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-2">
                                        {!! Form::text('tenure', "", ['class' => 'form-control numeric'] ) !!}
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('interest_type') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    {!! Form::text('interest_rates', 1.5, ['class' => 'form-control presentase'] ) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                            <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('rates_loan_total') ? 'has-error' : ''}}">
                                                {!! Form::label('loan_total', 'Jumlah Piutang Bunga', ['class' => 'control-label col-md-4 required-input '] ) !!}
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                                        {!! Form::text('rates_loan_total_label', 0, ['class' => 'form-control rupiah', 'readonly'=>'readonly'] ) !!}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('loan_total') ? 'has-error' : ''}}">
                                        {!! Form::label('loan_total', 'Jumlah Piutang Total', ['class' => 'control-label col-md-4 required-input '] ) !!}
                                        <div class="col-md-5">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                                {!! Form::text('loan_total_label', 0, ['class' => 'form-control rupiah', 'readonly'=>'readonly'] ) !!}
                                                {!! Form::hidden('loan_total', 0, ['class' => 'form-control'] ) !!}
                                            </div>
                                        </div>
                                    </div>    
                                </div>    
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('principal_amount') ? 'has-error' : ''}}">
                                            {!! Form::label('principal_amount', 'Angsuran Pokok Per-Tempo', ['class' => 'control-label col-md-4 required-input '] ) !!}
                                            <div class="col-md-5">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                                    {!! Form::text('principal_amount_label', 0, ['class' => 'form-control rupiah', 'readonly'=>'readonly'] ) !!}
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('rates_amount') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-5">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                                    {!! Form::text('rates_amount_label', 0, ['class' => 'form-control rupiah', 'readonly'=>'readonly'] ) !!}
                                ...
                                <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group form-md-line-input form-md-floating-label {{ $errors->has('rates_amount') ? 'has-error' : ''}}">
                                                {!! Form::label('angsuran_total_amount', 'Angsuran Total Per-Tempo', ['class' => 'control-label col-md-4 required-input '] ) !!}
                                                <div class="col-md-5">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                                        {!! Form::text('angsuran_total_amount_label', 0, ['class' => 'form-control rupiah', 'readonly'=>'readonly'] ) !!}
                                                    </div>
                                                </div>
                                            </div>    
                                        </div> 
                    ...
                    <div class="form-actions">
                        <div class="row">
                                ...
                                {!! Form::button('<i class="fa fa-check"></i> Simpan', ['class' => 'btn blue-sharp col-md-3 simpan', 'type' => 'submit', 'data-swa-text' => 'Menambahkan Pinjaman Elekronik', 'style' => 'margin-right:5px;']) !!}

...
@push('scripts')
    ...
    <script src="{{ assets('pages/scripts/SimpanPinjam/elektronik.show.js') }}" type="text/javascript"></script>
            ...
            <div class="col-lg-12 col-xs-12 col-sm-12">
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            <span class="caption-subject bold uppercase">Informasi Pinjaman Elektronik Anggota</span>
                        </div>
                        <div class="actions">
                                ...
                                <div class="row">
                                    ...
                                    @endif
                                        ...
                                        <div class="form-group form-md-line-input form-md-floating-label">
                                            ...
                                            <div class="col-md-8">
                                                <p class="form-control-static"> : Rp. {{ formatNoRpComma($data->saldo_pinjaman,0) }}  <span id="TotalPinjaman"></span></p>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach($data_pinjaman as $value)
                                                        <tr>
                                                            ...
                                                            <td class="text-right"><span style="float:left">Rp.</span> {{ formatNoRpComma($value->loan_amount,0)}}  </td>
                                                            <td class="text-right"><span style="float:left">Rp.</span> {{ formatNoRpComma($value->rates_total,0)}}  </td>
                                                            <td class="text-right subtotal"><span style="float:left">Rp.</span> {{ formatNoRpComma($value->loan_amount + $value->rates_total,0)}}  </td>
                                                                ...
                                                                @php
                                                                    if($value->status <> 1){
                                                                        switch ($value->lastlevel_app) {
                                                                            ...
                                                                            case 9:
                                                                                if(App\Http\Models\Pengaturan\Menu::isValid('simpanpinjam/elektronik/approvalpengajuansatu', auth()->user()->level_id) && ($value->approval_status <> 0)){
                                                                                    echo '<a class="approveBtn btn btn-xs blue-sharp" data-id="'.$value->loan_id.'" data-hreffaction="simpanpinjam/elektronik/approvalpengajuansatu"> <i class="fa fa-check-circle"></i> Setujui </a>';
                                                                                }    
                                                                                break;
                                                                            case 7:
                                                                                if(App\Http\Models\Pengaturan\Menu::isValid('simpanpinjam/elektronik/prosesserah', auth()->user()->level_id) && ($value->approval_status <> 0)){
                                                                                    echo Form::button('<i class="fa fa-money"></i> Proses Penyerahan', ['class' => 'btn btn-xs blue moveLink', 'data-swa-text' => 'Memproses Penyerahan Pinjaman Elketronik', 'data-spwjbid'=>Crypt::encrypt($value->loan_id)]);
                                                                                }
                                                                                break;
                                                                            default :
                                                                                if(App\Http\Models\Pengaturan\Menu::isValid('simpanpinjam/elektronik/approvalpengajuandua', auth()->user()->level_id)){
                                                                                    echo '<a class="approveBtn btn btn-xs blue-sharp" data-id="'.$value->loan_id.'" data-hreffaction="simpanpinjam/elektronik/approvalpengajuandua"> <i class="fa fa-check-circle"></i> Setujui </a>';
                                                                                }
                                                                        }
                                                                    }
                                                                @endphp
                ...
                <div class="row invoice-logo">
                    ...
                    <div class="col-xs-6">
                        <p> <h3><b>#<span id="popup_noref"></span> / <span id="popup_tgl_pengajuan"></span></b></h3>
                            <p> <h3><b><span id="popup_unitdesc"></span></h3>
                ...
                <div class="row">
                    <div class="col-xs-4">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li> Bunga Pinjaman <br> <span style="margin-left:10px;font-weight:bold;" id="popup_jenis_bunga"></span> </li>
                        </ul>
                    </div>
